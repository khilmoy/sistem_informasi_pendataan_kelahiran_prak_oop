...
public class GUI_Sistem_Data_Kelahiran extends javax.swing.JPanel {
    ...
    if(baris != -1){
        ...
        jTable1.setValueAt(txtNamaBayi.getText(), baris, 1);
        jTable1.setValueAt(txtNamaAyah.getText(), baris, 2);
        jTable1.setValueAt(txtNamaIbu.getText(), baris, 3);
        jTable1.setValueAt(cmb_Kelamin.getSelectedItem(), baris, 4);
        jTable1.setValueAt(txtTanggal.getText(), baris, 5);
        jTable1.setValueAt(txtAlamat.getText(), baris, 6);

        // Menambahkan satuan Kg dan Cm
        jTable1.setValueAt(txtBerat.getText() + " Kg", baris, 7);
        jTable1.setValueAt(txtPanjang.getText() + " Cm", baris, 8);

        jTable1.setValueAt(txtRS.getText(), baris, 9);
        jTable1.setValueAt(txtDokter.getText(), baris, 10);

        // Menghilangkan selection setelah edit
